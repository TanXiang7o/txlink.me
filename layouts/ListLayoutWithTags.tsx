    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-24">
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded bg-gray-50 shadow-md dark:bg-dark dark:shadow-gray-800/40 sm:flex">
            <div className="px-4 py-4">
              {pathname.startsWith('/blog') ? (
                <h3 className="px-3 py-2 font-bold text-primary-500">All Posts</h3>
              ) : (
                <Link
                  href={`/blog`}
                    ...
                    <li key={t} className="my-3">
                      {pathname.split('/tags/')[1] === slug(t) ? (
                        <h3 className="inline px-3 py-2 text-sm font-bold text-primary-500">
                          {`${t.charAt(0).toUpperCase() + t.slice(1)} (${tagCounts[t]})`}
                        </h3>
                      ) : (
                        <Link
                          href={`/tags/${slug(t)}`}
