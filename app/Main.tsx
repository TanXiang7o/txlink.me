    ...
    <>
      <div className="divide-y divide-gray-300 dark:divide-gray-700">
        <div className="space-y-2 pb-8 pt-6 md:space-y-5">
          <h1 className="font-playpen font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
        ...
        <ul className="divide-y divide-gray-300 dark:divide-gray-700">
          ...
          {posts.slice(0, MAX_DISPLAY).map((post) => {
            ...
            return (
              <li key={slug} className="py-12 hover:bg-gray-50 dark:hover:bg-zinc-800">
                <article>
