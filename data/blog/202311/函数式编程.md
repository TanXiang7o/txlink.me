...
tags: ['java']
draft: false
summary: '函数式编程是一种编程范式，它将计算机运算视为数学上的函数计算，并且避免使用程序状态以及可变数据。'
authors: ['default']
---
...
- ​	Consumer 消费接口
  ...
  ![image-20211028145622163](https://images.txserve.top/202311/images/image-20211028145622163.png)

- ​	Function 计算转换接口

  根据其中抽象方法的参数列表和返回值类型知道，我们可以在方法中对传入的参数计算或转换，把结果返回

  ![image-20211028145707862](https://images.txserve.top/202311/images/image-20211028145707862.png)

- ​	Predicate 判断接口

  根据其中抽象方法的参数列表和返回值类型知道，我们可以在方法中对传入的参数条件判断，返回判断结果

  ![image-20211028145818743](https://images.txserve.top/202311/images/image-20211028145818743.png)

- ​	Supplier 生产型接口

  根据其中抽象方法的参数列表和返回值类型知道，我们可以在方法中创建对象，把创建好的对象返回

![image-20211028145843368](https://images.txserve.top/202311/images/image-20211028145843368.png)
