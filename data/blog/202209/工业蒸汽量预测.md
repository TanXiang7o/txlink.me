...
![image-20220720132904618](https://images.txlink.top/202209/images/image-20220720132904618.png)
...
![image-20220720134418424](https://images.txlink.top/202209/images/image-20220720134418424.png)
...
![image-20220720134918005](https://images.txlink.top/202209/images/image-20220720134918005.png)
...
![image-20220720135406199](https://images.txlink.top/202209/images/image-20220720135406199.png)
...
![image-20220720140904522](https://images.txlink.top/202209/images/image-20220720140904522.png)
...
![image-20220720141820642](https://images.txlink.top/202209/images/image-20220720141820642.png)
...
![image-20220720143538861](https://images.txlink.top/202209/images/image-20220720143538861.png)
...
![image-20220720143947801](https://images.txlink.top/202209/images/image-20220720143947801.png)
...
![image-20220720154742940](https://images.txlink.top/202209/images/image-20220720154742940.png)
...
![image-20220720155118021](https://images.txlink.top/202209/images/image-20220720155118021.png)

**3.特征选择在python中的具体实现 **

![image-20220720155425369](https://images.txlink.top/202209/images/image-20220720155425369.png)
...
![image-20220720164236502](https://images.txlink.top/202209/images/image-20220720164236502.png)
...
![image-20220720164504180](https://images.txlink.top/202209/images/image-20220720164504180.png)
...
![image-20220722161513655](https://images.txlink.top/202209/images/image-20220722161513655.png)

**2.多元线性回归 **

使用多个特征的线性函数作为模型。

![image-20220722161620392](https://images.txlink.top/202209/images/image-20220722161620392.png)
...
![image-20220722170129637](https://images.txlink.top/202209/images/image-20220722170129637.png)

**2. 决策树回归举例 **

数据如表所示，

![image-20220722170258245](https://images.txlink.top/202209/images/image-20220722170258245.png)

由于特征为一维数据，因此可以考虑将分割点放在两点的中间。为了简化，这里将分割点定为x两点中较小的点。8个分割点为${2.92,3.7,4.94,5.01,5.36,6.88,8.34,9.2}$。

1. 选择最优分割点D，记为第k大的数。 损失函数为，

![image-20220722171815084](https://images.txlink.top/202209/images/image-20220722171815084.png)

2. 计算根据分割点D划分的子区域损失值。

当k=1时，即分割点为2.92时，

![image-20220722171934737](https://images.txlink.top/202209/images/image-20220722171934737.png)

遍历所有分割点，计算L(D)。

![image-20220722172006608](https://images.txlink.top/202209/images/image-20220722172006608.png)
...
![image-20220722172337681](https://images.txlink.top/202209/images/image-20220722172337681.png)

取分割点4.94， 对于右，

![image-20220722172351046](https://images.txlink.top/202209/images/image-20220722172351046.png)

取分割点9.2。

4. 生成决策树。

![image-20220722172456589](https://images.txlink.top/202209/images/image-20220722172456589.png)
...
![image-20220723100943316](https://images.txlink.top/202209/images/image-20220723100943316.png)
...
![image-20220723101245727](https://images.txlink.top/202209/images/image-20220723101245727.png)
...
![image-20220723101550704](https://images.txlink.top/202209/images/image-20220723101550704.png)
...
![image-20220723174116095](https://images.txlink.top/202209/images/image-20220723174116095.png)
...
![image-20220724170511011](https://images.txlink.top/202209/images/image-20220724170511011.png)

**2.MSE**

![image-20220724170549711](https://images.txlink.top/202209/images/image-20220724170549711.png)

**3.RMSE**

![image-20220724170615926](https://images.txlink.top/202209/images/image-20220724170615926.png)

**4.R平方值**

反映了回归模型在多大程度上解释了因变量的变化，或者说模型对观测值的拟合程度。

![image-20220724170729480](https://images.txlink.top/202209/images/image-20220724170729480.png)
