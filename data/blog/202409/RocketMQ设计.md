---
title: RocketMQ设计：架构、刷盘和负载均衡解析
date: '2024-09-10'
tags: ['RocketMQ', '消息存储', '刷盘方式', '负载均衡', '消息队列', '分布式系统']
draft: false
summary: '详细解析 RocketMQ 消息存储架构及刷盘方式，揭示消息过滤和负载均衡的实现。'
authors: ['default']
---
...
转载https://github.com/apache/rocketmq/blob/develop/docs/cn/design.md

### 1 消息存储

![](https://images.txserve.top/202409/images/rocketmq_design_1.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_2.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_3.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_4.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_5.png)

#### 2.4 Reactor多线程设计

RocketMQ的RPC通信采用Netty组件作为底层通信库，同样也遵循了Reactor多线程模型，同时又在这之上做了一些扩展和优化。

![](https://images.txserve.top/202409/images/rocketmq_design_6.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_7.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_8.png)

(4) 然后，调用updateProcessQueueTableInRebalance()方法，具体的做法是，先将分配到的消息队列集合（mqSet）与processQueueTable做一个过滤比对。

![](https://images.txserve.top/202409/images/rocketmq_design_9.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_10.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_11.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_12.png)
...
![](https://images.txserve.top/202409/images/rocketmq_design_13.png)
...
通过对RocketMQ设计架构的深入分析，我们可以看到其在消息存储、通信机制、消息过滤、负载均衡、事务处理和消息查询等方面的独特设计理念。这些设计不仅提高了系统的性能和可靠性，也为开发者提供了灵活的使用方式。随着微服务和分布式系统的不断发展，RocketMQ将继续发挥其重要作用。

### **常见问题解答**

1. **RocketMQ的主要优势是什么？**
   - RocketMQ具有高吞吐量、低延迟、可靠性强和灵活的消息传递模型等优势。
2. **RocketMQ支持哪些消息传递模式？**
   - RocketMQ支持点对点（P2P）和发布/订阅（Pub/Sub）两种消息传递模式。
3. **如何确保RocketMQ中的消息不丢失？**
   - 通过同步刷盘和异步刷盘机制，结合消息的持久化存储，确保消息在Broker端可靠存储。
4. **RocketMQ如何处理消息的重复消费？**
   - RocketMQ通过消息唯一性ID和事务机制，结合业务逻辑来避免重复消费。
5. **RocketMQ是否支持分布式事务？**
   - 是的，RocketMQ支持分布式事务消息，采用两阶段提交机制确保消息的一致性和可靠性。
