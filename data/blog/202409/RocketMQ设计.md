...
![](https://images.txlink.top/202409/images/rocketmq_design_1.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_2.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_3.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_4.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_5.png)

#### 2.4 Reactor多线程设计

RocketMQ的RPC通信采用Netty组件作为底层通信库，同样也遵循了Reactor多线程模型，同时又在这之上做了一些扩展和优化。

![](https://images.txlink.top/202409/images/rocketmq_design_6.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_7.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_8.png)

(4) 然后，调用updateProcessQueueTableInRebalance()方法，具体的做法是，先将分配到的消息队列集合（mqSet）与processQueueTable做一个过滤比对。

![](https://images.txlink.top/202409/images/rocketmq_design_9.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_10.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_11.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_12.png)
...
![](https://images.txlink.top/202409/images/rocketmq_design_13.png)
